...
internal sealed class PlanningBaselineConfiguration : IEntityTypeConfiguration<PlanningBaseline>
{
    ...
    {
        b.ToTable("planning_baselines"); b.ConfigureEntity(); b.HasIndex(e => e.Version).IsUnique(); b.Property(e => e.Status).AsEnumString(); b.Property(e => e.ApprovedBy).HasMaxLength(100); b.Property(e => e.KpiJson).AsJson(); b.Property(e => e.Notes).HasMaxLength(1000);
