...
7. Engine result for scenario 1: WO-2026-019 ELEC T0+8 06:00, INT **T0+9 14:00 → T0+11 10:00**, pulled forward 29 d; **8 operations differ from the approved baseline, of which 3 were moved by re-planning** (the rest are the delay's own effect, already visible in "before"); DOWNTIME_REDUCED 36→8. The result screen headlines the re-planning figure.
